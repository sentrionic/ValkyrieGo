...
var doc = `{
    ...
    "definitions": {
        ...
        "EditGuildRequest": {
            ...
            "properties": {
                "icon": {
                    "description": "The old guild icon url if no new image is selected. Set null the guild icon should be reset",
                    "type": "string"
                },
                "image": {
        ...
        "SuccessResponse": {
            ...
            "properties": {
                "success": {
                    "description": "Only returns true, not an json object",
                    "type": "boolean"
                }
            }
        },
